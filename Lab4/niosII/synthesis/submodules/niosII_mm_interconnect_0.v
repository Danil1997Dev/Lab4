...
module niosII_mm_interconnect_0 (
		...
		output wire        generator_0_avalon_slave_write,              //              generator_0_avalon_slave.write
		output wire [31:0] generator_0_avalon_slave_writedata,          //                                      .writedata
	...
	wire  [31:0] generator_0_avalon_slave_agent_m0_readdata;                                // generator_0_avalon_slave_translator:uav_readdata -> generator_0_avalon_slave_agent:m0_readdata
	wire         generator_0_avalon_slave_agent_m0_waitrequest;                             // generator_0_avalon_slave_translator:uav_waitrequest -> generator_0_avalon_slave_agent:m0_waitrequest
	wire         generator_0_avalon_slave_agent_m0_debugaccess;                             // generator_0_avalon_slave_agent:m0_debugaccess -> generator_0_avalon_slave_translator:uav_debugaccess
	wire  [17:0] generator_0_avalon_slave_agent_m0_address;                                 // generator_0_avalon_slave_agent:m0_address -> generator_0_avalon_slave_translator:uav_address
	wire   [3:0] generator_0_avalon_slave_agent_m0_byteenable;                              // generator_0_avalon_slave_agent:m0_byteenable -> generator_0_avalon_slave_translator:uav_byteenable
	wire         generator_0_avalon_slave_agent_m0_read;                                    // generator_0_avalon_slave_agent:m0_read -> generator_0_avalon_slave_translator:uav_read
	wire         generator_0_avalon_slave_agent_m0_readdatavalid;                           // generator_0_avalon_slave_translator:uav_readdatavalid -> generator_0_avalon_slave_agent:m0_readdatavalid
	wire         generator_0_avalon_slave_agent_m0_lock;                                    // generator_0_avalon_slave_agent:m0_lock -> generator_0_avalon_slave_translator:uav_lock
	wire  [31:0] generator_0_avalon_slave_agent_m0_writedata;                               // generator_0_avalon_slave_agent:m0_writedata -> generator_0_avalon_slave_translator:uav_writedata
	wire         generator_0_avalon_slave_agent_m0_write;                                   // generator_0_avalon_slave_agent:m0_write -> generator_0_avalon_slave_translator:uav_write
	wire   [2:0] generator_0_avalon_slave_agent_m0_burstcount;                              // generator_0_avalon_slave_agent:m0_burstcount -> generator_0_avalon_slave_translator:uav_burstcount
	wire         generator_0_avalon_slave_agent_rf_source_valid;                            // generator_0_avalon_slave_agent:rf_source_valid -> generator_0_avalon_slave_agent_rsp_fifo:in_valid
	wire  [94:0] generator_0_avalon_slave_agent_rf_source_data;                             // generator_0_avalon_slave_agent:rf_source_data -> generator_0_avalon_slave_agent_rsp_fifo:in_data
	wire         generator_0_avalon_slave_agent_rf_source_ready;                            // generator_0_avalon_slave_agent_rsp_fifo:in_ready -> generator_0_avalon_slave_agent:rf_source_ready
	wire         generator_0_avalon_slave_agent_rf_source_startofpacket;                    // generator_0_avalon_slave_agent:rf_source_startofpacket -> generator_0_avalon_slave_agent_rsp_fifo:in_startofpacket
	wire         generator_0_avalon_slave_agent_rf_source_endofpacket;                      // generator_0_avalon_slave_agent:rf_source_endofpacket -> generator_0_avalon_slave_agent_rsp_fifo:in_endofpacket
	wire         generator_0_avalon_slave_agent_rsp_fifo_out_valid;                         // generator_0_avalon_slave_agent_rsp_fifo:out_valid -> generator_0_avalon_slave_agent:rf_sink_valid
	wire  [94:0] generator_0_avalon_slave_agent_rsp_fifo_out_data;                          // generator_0_avalon_slave_agent_rsp_fifo:out_data -> generator_0_avalon_slave_agent:rf_sink_data
	wire         generator_0_avalon_slave_agent_rsp_fifo_out_ready;                         // generator_0_avalon_slave_agent:rf_sink_ready -> generator_0_avalon_slave_agent_rsp_fifo:out_ready
	wire         generator_0_avalon_slave_agent_rsp_fifo_out_startofpacket;                 // generator_0_avalon_slave_agent_rsp_fifo:out_startofpacket -> generator_0_avalon_slave_agent:rf_sink_startofpacket
	wire         generator_0_avalon_slave_agent_rsp_fifo_out_endofpacket;                   // generator_0_avalon_slave_agent_rsp_fifo:out_endofpacket -> generator_0_avalon_slave_agent:rf_sink_endofpacket
	wire         cmd_mux_001_src_valid;                                                     // cmd_mux_001:src_valid -> generator_0_avalon_slave_agent:cp_valid
	wire  [93:0] cmd_mux_001_src_data;                                                      // cmd_mux_001:src_data -> generator_0_avalon_slave_agent:cp_data
	wire         cmd_mux_001_src_ready;                                                     // generator_0_avalon_slave_agent:cp_ready -> cmd_mux_001:src_ready
	wire   [5:0] cmd_mux_001_src_channel;                                                   // cmd_mux_001:src_channel -> generator_0_avalon_slave_agent:cp_channel
	wire         cmd_mux_001_src_startofpacket;                                             // cmd_mux_001:src_startofpacket -> generator_0_avalon_slave_agent:cp_startofpacket
	wire         cmd_mux_001_src_endofpacket;                                               // cmd_mux_001:src_endofpacket -> generator_0_avalon_slave_agent:cp_endofpacket
	...
	wire         generator_0_avalon_slave_agent_rp_valid;                                   // generator_0_avalon_slave_agent:rp_valid -> router_003:sink_valid
	wire  [93:0] generator_0_avalon_slave_agent_rp_data;                                    // generator_0_avalon_slave_agent:rp_data -> router_003:sink_data
	wire         generator_0_avalon_slave_agent_rp_ready;                                   // router_003:sink_ready -> generator_0_avalon_slave_agent:rp_ready
	wire         generator_0_avalon_slave_agent_rp_startofpacket;                           // generator_0_avalon_slave_agent:rp_startofpacket -> router_003:sink_startofpacket
	wire         generator_0_avalon_slave_agent_rp_endofpacket;                             // generator_0_avalon_slave_agent:rp_endofpacket -> router_003:sink_endofpacket
	...
	wire         generator_0_avalon_slave_agent_rdata_fifo_src_valid;                       // generator_0_avalon_slave_agent:rdata_fifo_src_valid -> avalon_st_adapter_001:in_0_valid
	wire  [33:0] generator_0_avalon_slave_agent_rdata_fifo_src_data;                        // generator_0_avalon_slave_agent:rdata_fifo_src_data -> avalon_st_adapter_001:in_0_data
	wire         generator_0_avalon_slave_agent_rdata_fifo_src_ready;                       // avalon_st_adapter_001:in_0_ready -> generator_0_avalon_slave_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_001_out_0_valid;                                         // avalon_st_adapter_001:out_0_valid -> generator_0_avalon_slave_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_001_out_0_data;                                          // avalon_st_adapter_001:out_0_data -> generator_0_avalon_slave_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_001_out_0_ready;                                         // generator_0_avalon_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter_001:out_0_ready
	wire   [0:0] avalon_st_adapter_001_out_0_error;                                         // avalon_st_adapter_001:out_0_error -> generator_0_avalon_slave_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) generator_0_avalon_slave_translator (
		.clk                    (clk_clk_clk),                                     //                      clk.clk
		.reset                  (cpu_reset_reset_bridge_in_reset_reset),           //                    reset.reset
		.uav_address            (generator_0_avalon_slave_agent_m0_address),       // avalon_universal_slave_0.address
		.uav_burstcount         (generator_0_avalon_slave_agent_m0_burstcount),    //                         .burstcount
		.uav_read               (generator_0_avalon_slave_agent_m0_read),          //                         .read
		.uav_write              (generator_0_avalon_slave_agent_m0_write),         //                         .write
		.uav_waitrequest        (generator_0_avalon_slave_agent_m0_waitrequest),   //                         .waitrequest
		.uav_readdatavalid      (generator_0_avalon_slave_agent_m0_readdatavalid), //                         .readdatavalid
		.uav_byteenable         (generator_0_avalon_slave_agent_m0_byteenable),    //                         .byteenable
		.uav_readdata           (generator_0_avalon_slave_agent_m0_readdata),      //                         .readdata
		.uav_writedata          (generator_0_avalon_slave_agent_m0_writedata),     //                         .writedata
		.uav_lock               (generator_0_avalon_slave_agent_m0_lock),          //                         .lock
		.uav_debugaccess        (generator_0_avalon_slave_agent_m0_debugaccess),   //                         .debugaccess
		.av_write               (generator_0_avalon_slave_write),                  //      avalon_anti_slave_0.write
		.av_writedata           (generator_0_avalon_slave_writedata),              //                         .writedata
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) generator_0_avalon_slave_agent (
		.clk                     (clk_clk_clk),                                               //             clk.clk
		.reset                   (cpu_reset_reset_bridge_in_reset_reset),                     //       clk_reset.reset
		.m0_address              (generator_0_avalon_slave_agent_m0_address),                 //              m0.address
		.m0_burstcount           (generator_0_avalon_slave_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (generator_0_avalon_slave_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (generator_0_avalon_slave_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (generator_0_avalon_slave_agent_m0_lock),                    //                .lock
		.m0_readdata             (generator_0_avalon_slave_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (generator_0_avalon_slave_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (generator_0_avalon_slave_agent_m0_read),                    //                .read
		.m0_waitrequest          (generator_0_avalon_slave_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (generator_0_avalon_slave_agent_m0_writedata),               //                .writedata
		.m0_write                (generator_0_avalon_slave_agent_m0_write),                   //                .write
		.rp_endofpacket          (generator_0_avalon_slave_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (generator_0_avalon_slave_agent_rp_ready),                   //                .ready
		.rp_valid                (generator_0_avalon_slave_agent_rp_valid),                   //                .valid
		.rp_data                 (generator_0_avalon_slave_agent_rp_data),                    //                .data
		.rp_startofpacket        (generator_0_avalon_slave_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (generator_0_avalon_slave_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (generator_0_avalon_slave_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (generator_0_avalon_slave_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (generator_0_avalon_slave_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (generator_0_avalon_slave_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (generator_0_avalon_slave_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (generator_0_avalon_slave_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (generator_0_avalon_slave_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (generator_0_avalon_slave_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (generator_0_avalon_slave_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_001_out_0_ready),                         // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_001_out_0_valid),                         //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_001_out_0_data),                          //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_001_out_0_error),                         //                .error
		.rdata_fifo_src_ready    (generator_0_avalon_slave_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (generator_0_avalon_slave_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (generator_0_avalon_slave_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                                     //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                                       //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) generator_0_avalon_slave_agent_rsp_fifo (
		.clk               (clk_clk_clk),                                               //       clk.clk
		.reset             (cpu_reset_reset_bridge_in_reset_reset),                     // clk_reset.reset
		.in_data           (generator_0_avalon_slave_agent_rf_source_data),             //        in.data
		.in_valid          (generator_0_avalon_slave_agent_rf_source_valid),            //          .valid
		.in_ready          (generator_0_avalon_slave_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (generator_0_avalon_slave_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (generator_0_avalon_slave_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (generator_0_avalon_slave_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (generator_0_avalon_slave_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (generator_0_avalon_slave_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (generator_0_avalon_slave_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (generator_0_avalon_slave_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                                     // (terminated)
		.csr_read          (1'b0),                                                      // (terminated)
		.csr_write         (1'b0),                                                      // (terminated)
		.csr_readdata      (),                                                          // (terminated)
	...
	niosII_mm_interconnect_0_router_002 router_003 (
		.sink_ready         (generator_0_avalon_slave_agent_rp_ready),         //      sink.ready
		.sink_valid         (generator_0_avalon_slave_agent_rp_valid),         //          .valid
		.sink_data          (generator_0_avalon_slave_agent_rp_data),          //          .data
		.sink_startofpacket (generator_0_avalon_slave_agent_rp_startofpacket), //          .startofpacket
		.sink_endofpacket   (generator_0_avalon_slave_agent_rp_endofpacket),   //          .endofpacket
		.clk                (clk_clk_clk),                                     //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset),           // clk_reset.reset
	...
	niosII_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_0_data      (generator_0_avalon_slave_agent_rdata_fifo_src_data),  //     in_0.data
		.in_0_valid     (generator_0_avalon_slave_agent_rdata_fifo_src_valid), //         .valid
		.in_0_ready     (generator_0_avalon_slave_agent_rdata_fifo_src_ready), //         .ready
